...
case '4':
    ...
    $footer_class[2] = 'col-lg-2 col-md-6 col-sm-6';
...
<footer>
    <div class="footer-area tpfooter__theme-bg theme-bg " style="<?php echo esc_attr($footer_bg);?>">
        ...
        <div class="tpfooter__main pb-55 pt-50">
            <div class="container">
                <div class="row">
                    <?php
                        if ( $footer_columns < 4 ) {
                        ...
                        print '<div class="col-lg-3 col-md-6 col-sm-5">';
        ...
        <?php endif; ?>
        <div class="tpfooter__copy-right tpfooter__copy-right-two">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="tpfooter__copy-right__content text-center pt-20 pb-25">

...
class TP_About extends Widget_Base {
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
            'tp_features_title', [
                ...
                'default' => esc_html__('About Title', 'tpcore'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'fadeLeft' => __( 'Fade Left', 'tpcore' ),
                    'fadeRight' => __( 'Fade Right', 'tpcore' ),
	...
	protected function render() {
        ...
        <?php else: 
			...
			$this->add_render_attribute('title_args', 'class', 'tpabout__title mb-10');
...
<section class="about-area grey-bg pt-115 pb-90">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 ">
                <?php if(!empty($tp_image)) : ?>
                <div class="tpabout__thumb pb-40 wow fadeInUp" data-wow-duration="2s" data-wow-delay=".4s">
                    <img src="<?php echo esc_url($tp_image); ?>" alt="<?php echo esc_attr($tp_image_alt); ?>">
                </div>
                <?php endif; ?>
            </div>
            <div class="col-xl-7 col-lg-8 offset-xl-1 col-md-8">
                <div class="tpabout__wrapper">
                    <div class="tpabout__content mb-50">

                        <?php if ( !empty($settings['tp_sub_title']) ) : ?>
                            <h5 class="tpabout__sub-title"><?php echo tp_kses( $settings['tp_sub_title'] ); ?></h5>
                        <?php endif; ?>
                ...
                <div class="row gx-6">
                    ...
                    <?php foreach ($settings['tp_features_list'] as $key => $item) : 
                        // Link
                        if ('2' == $item['tp_about_link_type']) {
                            $link = get_permalink($item['tp_about_page_link']);
                            $target = '_self';
                            $rel = 'nofollow';
                        } else {
                            $link = !empty($item['tp_about_link']['url']) ? $item['tp_about_link']['url'] : '';
                            $target = !empty($item['tp_about_link']['is_external']) ? '_blank' : '';
                            $rel = !empty($item['tp_about_link']['nofollow']) ? 'nofollow' : '';
                        }
                    ?>
                    <div class="col-lg-4 col-md-4 col-sm-6">
                    <?php if(!empty($item['tp_creative_anima_switcher'])) : ?>
                        <div class="tpabout__services-item mb-30 wow <?php echo esc_attr($item['animation_type']); ?>" data-wow-duration="<?php echo esc_attr($item['tp_anima_dura']);?>" data-wow-delay="<?php echo esc_attr($item['tp_anima_delay']);?>">
                        <?php else : ?>
                            <div class="tpabout__services-item mb-30 " >
                        <?php endif; ?>
                        
                            <?php if($item['tp_features_icon_type'] !== 'image') : ?>
                                <?php if (!empty($item['tp_features_icon']) || !empty($item['tp_features_selected_icon']['value'])) : ?>
                                    <div class="tpabout__services-icon mb-25">
                            ...
                            <?php else : ?>
                                <?php if (!empty($item['tp_features_image']['url'])): ?>
                                    <div class="tpabout__services-icon mb-25">
                                        <img src="<?php echo $item['tp_features_image']['url']; ?>" alt="<?php echo get_post_meta(attachment_url_to_postid($item['tp_service_image']['url']), '_wp_attachment_image_alt', true); ?>">
                                    </div>
                                <?php endif; ?>  
                            <?php endif; ?>  

                            <div class="tpabout__services-text">
                                <?php if(!empty($item['tp_features_title'])) : ?>
                                <h5 class="tpabout__services-title mb-20"><?php echo tp_kses($item['tp_features_title']); ?></h5>
                                <?php endif; ?>
                                <?php if(!empty($link)) : ?>
                                <a href="<?php echo esc_url($link); ?>" target="<?php echo esc_attr($target); ?>" rel="<?php echo esc_attr($rel); ?>"><i class="arrow_right"></i></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>

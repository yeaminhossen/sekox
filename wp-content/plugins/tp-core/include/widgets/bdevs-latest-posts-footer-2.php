<?php 
Class Latest_posts_footer2_Widget extends WP_Widget{

	public function __construct(){
		parent::__construct('bdevs-latest-posts2-footer', 'Bizker Footer 2 Posts Image', array(
	     	...
	     	<div class="tp-footer-news tp-footer-news-three">
				...
				?>
		            <div class="tp-footer-news-single tp-footer-news-three-single mb-10">
		                <div class="tp-footer-news-three-single-img bg-blend">
...
add_action('widgets_init', function(){
	register_widget('Latest_posts_footer2_Widget');
});